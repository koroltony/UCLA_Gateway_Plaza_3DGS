...
with tab1:
    ...
    st.write("Move red slider to select frames. \n Move image slider to reveal GS/Ground-Truth")
    ...
    if total_frames == 0:
        ...
        frame_idx = st.slider("Timeline Tracking Index", min_value=0, max_value=total_frames - 1, value=0)
        ...
        # --- CENTERING MECHANISM ---
        # We create 3 columns. The middle column [3] is wide, flanked by narrow [1] empty columns to push it center.
